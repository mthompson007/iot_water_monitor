...
#include "water_monitor.h"        // stores WiFi and AWS credentials
...
const char* ssid = CONST_SSID;
const char* password = CONST_PASSWORD;          // defined in water_monitor.h
const char* awskeyid = CONST_AWSKEYID;          // defined in water_monitor.h
const char* awssecretkey = CONST_AWSSECRETKEY;  // defined in water_monitor.h
const char* awsdomain = CONST_AWSDOMAIN;        // defined in water_monitor.h
const char* awsregion = CONST_AWSREGION;        // defined in water_monitor.h
...
const char* rtcHost = "time.nist.gov";          // Round-robin DAYTIME protocol; do not query more than 1 per min
